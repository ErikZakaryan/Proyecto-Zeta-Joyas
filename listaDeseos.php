...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="estiloPagPrincipalZetaJoyas.css">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
    <link rel="stylesheet" type="text/css" href="home.css">
    <link rel="stylesheet" type="text/css" href="listaDeseos.css">
        ...
        <div class="row">
            ...
            <div class="col-7">
                ...
                <?php
                    ...
                    $queryListaDeseos = "select * from mercaderia, listadeseos where listadeseos.idusuario = $idUsuario and mercaderia.id=listadeseos.idMercaderia";
                    ...
                    <div class="card" style="width: 16rem; margin:1rem">
                        ...
                        <div class="card-body">
                            ...
                            ?>
                                ...
                                <input hidden type="text" name="desde" value="listaDeseos">
                                <?php
                                    $queryCarrito = "select * from listadeseos where idUsuario = $idUsuarioLogueado and idMercaderia = $idProducto";
                                    ...
                                    if($siEnCarrito > 0){
                                        ...
                                        echo "<button class='btn btn-primary'>Quitar de la Lista de Deseos</button>";
                                    }
                                ?>
                            </form>
